...
const Account = () => {
  ...
  return (
    <section className="min-h-screen flex justify-center items-center">
      <div className="max-w-[500px] p-7 flex flex-col gap-7 *:flex *:gap-5 text-3xl ">
        <div>
        ...
        {changePassword && (
          ...
          >
            <input
              ...
              name="password"
              className="outline outline-1 focus:outline-gray-500 rounded-lg p-5"
            />
            <button
              type="button"
              className="absolute top-[50%] translate-y-[-50%] right-[20%] text-gray-500"
            ...
            <button
              type="submit"
              className="bg-black text-white hover:bg-white hover:text-black transition-colors duration-250 px-5 py-5 rounded-lg border border-transparent hover:border-black"
            >
              Reset
            </button>
          </form>
